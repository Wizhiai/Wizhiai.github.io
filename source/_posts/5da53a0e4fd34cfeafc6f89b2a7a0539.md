...
- [MySQL](https://kai-keng.github.io/java-learning/mysql/)
  ...
  - [数据类型](https://kai-keng.github.io/java-learning/mysql/datatype.html)
...
<img width="740" height="438" src=":/2fcd6dc125e64da6b298fb7875367254"/>
...
- 当索引列中列的最左列索引在查询时如果缺失的话，索引是不生效的，但是缺失后续的字段则不影响索引，且=和in查询可以更换字段位置 <img width="721" height="437" src=":/bfe8bc473b094b3088061e9768bbd18e"/>
